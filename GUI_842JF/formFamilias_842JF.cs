...
namespace GUI_842JF
{
    public partial class formFamilias_842JF : Form, IIdiomaObserver_842JF
    {
        ...
        public formFamilias_842JF()
        {
            ...
            IM_842JF.CargarFormulario_842JF("formFamilias_842JF");
            Actualizar_842JF();
        }
        private void Labels_842JF()
        {
            ...
            {
                label5.Text = IM_842JF.ObtenerString_842JF("label.seleccionadoFamilia") + " " + treeView1.SelectedNode.Text;
            }
            if (familia_842JF != null)
            {
                label6.Text = IM_842JF.ObtenerString_842JF("label.seleccionadoAAgregar") + " " + familia_842JF.nombre_842JF;
            }
        }
        ...
        public void Actualizar_842JF()
        {
            ...
            label5.Text = IM_842JF.ObtenerString_842JF("label.seleccionadoFamilia");
            label6.Text = IM_842JF.ObtenerString_842JF("label.seleccionadoAAgregar");
            Labels_842JF();
            button1.Text = IM_842JF.ObtenerString_842JF("button.generarFamilia");
            ...
            button4.Text = IM_842JF.ObtenerString_842JF("button.eliminarFamilia");
            button5.Text = IM_842JF.ObtenerString_842JF("button.eliminarHijo");
            button6.Text = IM_842JF.ObtenerString_842JF("button.salir");
            button9.Text = IM_842JF.ObtenerString_842JF("button.seleccionar");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int cod = 1;
                if (bllfamilia_842JF.ObtenerTodas_842JF().Count() > 0)
                { cod = bllfamilia_842JF.ObtenerTodas_842JF().Last().codPerfil_842JF + 1; }
                bllfamilia_842JF.GuardarFamilia_842JF(new Familia_842JF(cod, descripcion, nombre));
                bLLBitacoraEvento_842JF.RegistrarEvento_842JF(new BEEvento_842JF(bLLBitacoraEvento_842JF.ObtenerTodos_842JF().Count + 1, SessionManager_842JF.Instancia.Usuario_842JF.login_842JF, DateTime.Now, "Admin", "Generar Familia", 2));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (treeView1.SelectedNode == null)
                {
                    throw new Exception(IM_842JF.ObtenerString_842JF("mensaje.seleccionVaciaTree"));
                }
                if (treeView1.SelectedNode.Parent != null)
                {
                    throw new Exception(IM_842JF.ObtenerString_842JF("mensaje.noEsFamilia"));
                }
                Familia_842JF familia = bllfamilia_842JF.ObtenerTodas_842JF().Find(x => x.nombre_842JF == treeView1.SelectedNode.Text);
                Permiso_842JF permiso = bllpermiso_842JF.ObtenerTodos_842JF().Find(x => x.nombre_842JF == listBox1.SelectedItems[0].ToString());
                bllfamilia_842JF.AgregarPermiso_842JF(familia, permiso);
                RellenarCosas_842JF();
            }
            catch (Exception ex)
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                if (familia_842JF == null)
                {
                    throw new Exception(IM_842JF.ObtenerString_842JF("mensaje.familiaNoSeleccionada"));
                }
                if (treeView1.SelectedNode == null)
                {
                    throw new Exception(IM_842JF.ObtenerString_842JF("mensaje.seleccionVaciaTree"));
                ...
                Familia_842JF familia = bllfamilia_842JF.ObtenerTodas_842JF().Find(x => x.nombre_842JF == treeView1.SelectedNode.Text);
                bllfamilia_842JF.AgregarFamilia_842JF(familia, familia_842JF);
                RellenarCosas_842JF();
            }
            catch (Exception ex)
            {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (msgBox_842JF.Show_842JF(IM_842JF.ObtenerString_842JF("mensaje.seguroEliminar"), IM_842JF.ObtenerString_842JF("alerta"), IM_842JF.ObtenerString_842JF("messagebox.button.aceptar"), IM_842JF.ObtenerString_842JF("messagebox.button.cancelar"), MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    bllfamilia_842JF.EliminarFamilia_842JF(familia);
                    RellenarCosas_842JF();
                }
            }
            catch (Exception ex)
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (treeView1.SelectedNode.Parent == null)
                {
                    throw new Exception(IM_842JF.ObtenerString_842JF("mensaje.EsFamilia"));
                }
                ...
                {
                    Perfil_842JF familia = bllfamilia_842JF.ObtenerTodas_842JF().Find(x => x.nombre_842JF == treeView1.SelectedNode.Parent.Text);
                    Perfil_842JF hijo = familia.ObtenerHijo_842JF(treeView1.SelectedNode.Tag as Perfil_842JF);
                    familia.EliminarHijo_842JF(hijo);
                    bllfamilia_842JF.EliminarHijo_842JF(familia, hijo);
                    RellenarCosas_842JF();
                }
            }
            catch (Exception ex)
        ...
        private void formFamilias_842JF_Load(object sender, EventArgs e)
        {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                familia_842JF = bllfamilia_842JF.ObtenerTodas_842JF().Find(x => x.nombre_842JF == treeView1.SelectedNode.Text);
                Labels_842JF();
            }
            catch (Exception ex)
            {
        ...
        private void formFamilias_842JF_Enter(object sender, EventArgs e)
        {
            IM_842JF.CargarFormulario_842JF("formFamilias_842JF");
            RellenarCosas_842JF();
        }
        ...
        private void formFamilias_842JF_FormClosed(object sender, FormClosedEventArgs e)
        {
